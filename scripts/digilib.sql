...
/* Created on:     8/2/2004 10:42:43 AM                         */
/*==============================================================*/
...
create table ITEM (
   ...
   PRIMARYAUTHOR         VARCHAR2(200)                  not null, 
   EDITION              VARCHAR2(50),
...
create table ITEM_RELATIONSHIP (
   ...
   constraint FK_ITEM_REL_ITEM_RELA_ITEM1 foreign key (ITEMNO)
         references ITEM (ITEMNO),
   constraint FK_ITEM_REL_ITEM_RELA_ITEM2 foreign key (ITE_ITEMNO)
         references ITEM (ITEMNO)
)
/
