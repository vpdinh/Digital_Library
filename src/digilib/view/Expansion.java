...
public class Expansion extends View {
	...
	public static boolean post(Long newDocumentNo,
		...
		CallableStatement cstm = conn.prepareCall("{?=call EXPANSIONS.POST(?,?)}");
	...
	public ExpansionDetail getDetails() throws SQLException {
		ExpansionDetail expansionDetails = new ExpansionDetail();
		expansionDetails.setCriteria("DOCUMENTNO = " + this.getDocumentNo().longValue());
