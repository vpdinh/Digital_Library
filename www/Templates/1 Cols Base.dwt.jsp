...
%>
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/Base.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
<head>
    ...
    <td height="100%" valign="top">
      <table width="760" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="600" height="100%" valign="top"><!-- InstanceBeginEditable name="Content" -->
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- TemplateBeginEditable name="MainContent" --><!-- TemplateEndEditable --></td>
              </tr>
            </table>
            <!-- InstanceEndEditable --></td>
        </tr>
