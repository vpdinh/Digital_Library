...
public class _members extends oracle.jsp.runtime.HttpJsp {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      digilib.view.Member Members;
      if ((Members = (digilib.view.Member) pageContext.getAttribute( "Members", PageContext.PAGE_SCOPE)) == null) {
        Members = (digilib.view.Member) new digilib.view.Member();
      ...
      out.print(__jsp_StaticText.text[8]);
      	...
      	Members.open();
      	int totalRecords = Members.getMaxRows();
      ...
      out.print( Members.getMemberID() );
      out.print(__jsp_StaticText.text[11]);
      out.print( Format.formatMemberID(Members.getMemberID()));
      out.print(__jsp_StaticText.text[12]);
      out.print( Members.getMemberID() );
      out.print(__jsp_StaticText.text[13]);
      out.print( Members.getName());
      out.print(__jsp_StaticText.text[14]);
      out.print( (Members.getGender().intValue() == 1) ? "Nam" : "Nữ" );
      out.print(__jsp_StaticText.text[15]);
      out.print( Format.formatShortDate(Members.getBirthday()) );
      out.print(__jsp_StaticText.text[16]);
      out.print( Format.formatDisplayString(Members.getAddress()) );
      out.print(__jsp_StaticText.text[17]);
      out.print( Format.formatDisplayString(Members.getPhone()) );
      out.print(__jsp_StaticText.text[18]);
      out.print( Format.formatDisplayString(Members.getFax()) );
      out.print(__jsp_StaticText.text[19]);
      out.print( Members.getEmail() );
      out.print(__jsp_StaticText.text[20]);
      out.print( Format.formatShortDate(Members.getIssuedDate()) );
      out.print(__jsp_StaticText.text[21]);
      out.print( Format.formatShortDate(Members.getExpireDate()) );
      ...
      out.print( (Members.getGroupID().equals(GroupsInfo[j][0])) ? "selected=\"selected\"" : "" );
      ...
      out.print( Format.formatTimeStamp(Members.getAudTime()) );
      out.print(__jsp_StaticText.text[29]);
      out.print( Members.getAudUser() );
  ...
  private static class __jsp_StaticText {
    ...
    static {
      ...
      text[10] = 
      "\" id=\"divDisplay\" style=\"border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;\">\r\n                                        <tr>\r\n                                          <td width=\"100\" rowspan=\"14\" align=\"center\" valign=\"top\"><img src=\"/images/member.jsp?memberid=".toCharArray();
      text[11] = 
      "\" width=\"90\" height=\"120\" />\r\n                                            ".toCharArray();
      text[12] = 
      "\r\n                                            <input name=\"MemberID\" type=\"hidden\" id=\"MemberID\" value=\"".toCharArray();
      text[13] = 
