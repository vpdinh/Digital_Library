...
<script language="JavaScript" src="classifications.js"></script>
<script language="JavaScript">
	DataForm="ClassificationInfoForm";
	DataFormAction = "/process/classifications.jsp";
        ...
        <tr>
          <td width="300" height="50">
            <table width="300" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!-- InstanceBeginEditable name="HeaderImage" --><img src="/images/header_classifications.gif" width="300" height="50" /><!-- InstanceEndEditable --></td>
              </tr>
            </table>
          </td>
          <td width="310">
              ...
              <tr>
                <td align="center" valign="top">
                  ...
                  <table width="150" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="10">&nbsp;</td>
                      <td width="125" align="right"><a href="#">Thang phân loại 
                        Dewey</a></td>
                      <td width="5">&nbsp;</td>
                      <td width="10" valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
            ...
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- InstanceBeginEditable name="MainContent" --> 
                  <form name="ClassificationInfoForm" id="ClassificationInfoForm" method="post" action="/process/classifications.jsp">
                    <table width="590" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td width="10"><img src="/images/lefttop_curve.gif" width="10" height="20" /></td>
                        <td width="430" bgcolor="#663300" class="headline">Thang 
                          phân loại Dewey</td>
...
<table width="580" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    ...
                                    <td width="110" align="center" bgcolor="#083908" class="headline">Mã 
                                      Dewey </td>
                                    <td width="240" align="center" bgcolor="#083908" class="headline">Diễn 
                                      giải</td>
                                  ...
                                  <tr> 
									...
									<table width="580" border="0" cellpadding="5" cellspacing="0" class="data" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <jsp:useBean id="Classifications" scope="page" class="digilib.view.Classification" />
<%
	Date now = new Date();
	int Page = 1;
	int PageSize = 20;
	...
	Classifications.setPageSize(PageSize);
	Classifications.setPage(Page);
	//Classifications.setCriteria(sCriteria);
	Classifications.open();
	int totalRecords = Classifications.getMaxRows();
...
%>																	  
                                        <tr id="divDisplay" bgcolor="<%=(i%2==0)?"#ffffff":"ffffcc"%>"> 
                                          ...
                                          <td width="100" style="border-right: #999999 1px solid; border-bottom: #999999 1px solid;"><%= Classifications.getDDCID() %></td>
                                          <td width="240" style="border-right: #999999 1px solid; border-bottom: #999999 1px solid;"><%= Classifications.getName() %></td>
                                          <td width="180" style="border-bottom: #999999 1px solid;"><em><%= Format.formatTimeStamp(Classifications.getAudTime()) %> - (<%= Classifications.getAudUser() %>)</em></td>
                                        </tr>
...
<input name="DDCID" type="hidden" id="DDCID" value="<%= Classifications.getDDCID() %>" />
                                            <%= Classifications.getDDCID() %></td>
                                          <td width="240" style="border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
<input name="Name" type="text" class="textbox" id="Name" value="<%=Classifications.getName()%>" maxlength="100" /> 
                                          </td>
...
%>								  																				
                                        ...
                                        <tr id="divEdit" style="display:none;" bgcolor="<%=(i%2==0)?"#ffffff":"ffffcc"%>"> 
                                          ...
                                          <td width="100" style="border-right: #999999 1px solid;"><input name="DDCID" type="text" class="textbox" id="DDCID" maxlength="20" onblur="checkLanguageID(<%= i %>);" /></td>
