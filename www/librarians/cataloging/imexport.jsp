...
<title>D I G I L I B &gt; Thủ thư &gt; Biên mục tài liệu &gt; Xuất/Nhập dữ liệu</title>
<!-- InstanceEndEditable -->
        ...
        <tr>
          <td width="300" height="50">
            <table width="300" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!-- InstanceBeginEditable name="HeaderImage" --><img src="/images/header_imexport.gif" width="300" height="50" /><!-- InstanceEndEditable --></td>
              </tr>
            </table>
          </td>
          <td width="310">
              ...
              <tr>
                <td align="center" valign="top">
                  ...
                  <table width="150" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="10">&nbsp;</td>
                      <td width="125" align="right"><a href="#">Nhập / Xuất dữ 
                        liệu</a></td>
                      <td width="5">&nbsp;</td>
                      <td width="10" valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
            ...
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- InstanceBeginEditable name="MainContent" --> 
                  <form action="export.jsp" method="post" name="ExportForm" target="_blank" id="ExportForm">
                    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td width="10"><img src="/images/lefttop_curve.gif" width="10" height="20" /></td>
                        <td width="340" bgcolor="#663300" class="headline">Xuất 
                          dữ liệu tài liệu --&gt; MARC file (XML)</td>
                      ...
                      <tr> 
                        <td colspan="3"><table width="500" border="0" cellspacing="5" cellpadding="0">
                            ...
                            <tr> 
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                              <td align="center"><input name="Submit" type="submit" class="button" value="Xuất" /></td>
                              <td>&nbsp;</td>
                            </tr>
                          </table></td>
                      </tr>
