...
<script language="JavaScript">
	DataForm="LanguageInfoForm";
	DataFormAction = "/process/languages.jsp";
	DataSet =  "Languages";
</script>
<!-- InstanceEndEditable -->
        ...
        <tr>
          <td width="300" height="50">
            <table width="300" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!-- InstanceBeginEditable name="HeaderImage" --><img src="/images/header_languages.gif" width="300" height="50" /><!-- InstanceEndEditable --></td>
              </tr>
            </table>
          </td>
          <td width="310">
              ...
              <tr>
                <td align="center" valign="top">
                  ...
                  <table width="150" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="10">&nbsp;</td>
                      <td width="125" align="right"><a href="#">Danh mục Ngôn 
                        ngữ</a></td>
                      <td width="5">&nbsp;</td>
                      <td width="10" valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
            ...
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- InstanceBeginEditable name="MainContent" --> 
                  <form name="LanguageInfoForm" id="LanguageInfoForm" method="post" action="/process/languages.jsp">
...
<%
	...
	Languages.setPageSize(PageSize);
	Languages.setPage(Page);
	//Languages.setCriteria(sCriteria);
	Languages.open();
	int totalRecords = Languages.getMaxRows();
...
%>																	  
                                        <tr id="divDisplay" bgcolor="<%=(i%2==0)?"#ffffff":"ffffcc"%>"> 
                                          ...
                                          <td width="100" style="border-right: #999999 1px solid; border-bottom: #999999 1px solid;"><%= Languages.getLanguageID() %></td>
                                          <td width="240" style="border-right: #999999 1px solid; border-bottom: #999999 1px solid;"><%= Languages.getName() %></td>
                                          <td width="180" style="border-bottom: #999999 1px solid;"><em><%= Format.formatTimeStamp(Languages.getAudTime()) %> - (<%= Languages.getAudUser() %>)</em></td>
                                        </tr>
...
<input name="LanguageID" type="hidden" id="LanguageID" value="<%= Languages.getLanguageID() %>" />
                                            <%= Languages.getLanguageID() %></td>
                                          <td width="240" style="border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
<input name="Name" type="text" class="textbox" id="Name" value="<%=Languages.getName()%>" maxlength="100" /> 
                                          </td>
...
%>								  																				
                                        ...
                                        <tr id="divEdit" style="display:none;" bgcolor="<%=(i%2==0)?"#ffffff":"ffffcc"%>"> 
                                          ...
                                          <td width="100" style="border-right: #999999 1px solid;"><input name="LanguageID" type="text" class="textbox" id="LanguageID" maxlength="6" onblur="checkLanguageID(<%= i %>);" /></td>
