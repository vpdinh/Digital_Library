...
<title>D I G I L I B &gt; Thủ thư &gt; Quản lý thư viện &gt; Phiếu mượn đã lập</title>
        ...
        <tr>
          <td width="300" height="50">
            <table width="300" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!-- InstanceBeginEditable name="HeaderImage" --><img src="/images/header_confirmloans.gif" width="300" height="50" /><!-- InstanceEndEditable --></td>
              </tr>
            </table>
          </td>
          <td width="310">
              ...
              <tr>
                <td align="center" valign="top">
                  ...
                  <table width="150" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="10">&nbsp;</td>
                      <td width="125" align="right"><a href="/librarians/management/loans.jsp">Cho 
                        mượn tài liệu</a></td>
                      <td width="5">&nbsp;</td>
                      <td width="10" valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
                      <td align="right"><a href="#">Phiếu mượn đã lập</a></td>
                      <td>&nbsp;</td>
                      <td valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
                    <tr> 
                      <td width="10">&nbsp;</td>
                      <td width="125" align="right"><a href="/librarians/management/returns.jsp">Thu 
                        hồi tài liệu</a></td>
                      <td width="5">&nbsp;</td>
                      <td width="10" valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
            ...
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- InstanceBeginEditable name="MainContent" -->
                  <form name="ConfirmLoanForm" id="ConfirmLoanForm" method="post" action="/process/loans.jsp?action=post" onsubmit="return checkData();">
                    <table width="590" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="10"><img src="/images/lefttop_curve.gif" width="10" height="20" /></td>
                        <td width="430" bgcolor="#663300" class="headline">Danh sách các phiếu mượn tài liệu đã lập</td>
                      ...
                      <tr>
                        <td colspan="3">
                          <table width="590" border="0" cellspacing="5" cellpadding="0">
                            <tr>
                              <td>
                                <jsp:useBean id="curLoan" scope="page" class="digilib.view.Loan" />
<%@ page import="digilib.view.LoanDetail" %>
<%
	String sCriteria = "";
	try {
...
%>
                                <table width="580" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="530" bgcolor="#083908" class="headline">Phiếu mượn số : <%= curLoan.getDocumentNo() %> - Mã độc giả <%= Format.formatMemberID(curLoan.getMemberID()) %></td>
                                    <td width="30" align="center" bgcolor="#083908" class="headline">
                                      <input name="accepted" type="checkbox" id="accepted" value="<%= curLoan.getDocumentNo() %>" />
                                    </td>
                                  ...
                                  <tr>
                                    <td colspan="4">                                      									
                                      <%
	LoanDetail curDetails = curLoan.getDetails();
	curDetails.open();
	int id = 0;
...
%>
                                      <table width="580" border="0" cellpadding="5" cellspacing="0" bgcolor="<%= (id % 2 == 0) ? "#ffffff" : "#ffffcc" %>" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <tr>
                                          <td width="35" align="center" style="border-right: #999999 1px solid;"><img src="/images/remove_up.gif" width="10" height="10" class="picbutton" onclick="doRemoveDetail(<%= curLoan.getDocumentNo() %>, <%= curDetails.getItemNo() %>);" /></td>
