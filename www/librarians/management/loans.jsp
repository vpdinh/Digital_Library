...
<title>D I G I L I B &gt; Thủ thư &gt; Quản lý thư viện &gt; Cho mượn tài liệu</title>
<script language="JavaScript" src="/digilib.js"></script>
<script language="JavaScript" src="/data.js"></script>
<script language="JavaScript" src="loans.js"></script>
<!-- InstanceEndEditable -->
        ...
        <tr>
          <td width="300" height="50">
            <table width="300" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!-- InstanceBeginEditable name="HeaderImage" --><img src="/images/header_loans.gif" width="300" height="50" /><!-- InstanceEndEditable --></td>
              </tr>
            </table>
          </td>
          <td width="310">
...
%>				  
  ...
  <tr>
              ...
              <tr>
                <td align="center" valign="top">
                  ...
                  <table width="150" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td>&nbsp;</td>
                      <td align="right"><a href="#">Cho mượn tài liệu</a></td>
                      <td>&nbsp;</td>
                      <td valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
                    <tr> 
            ...
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- InstanceBeginEditable name="MainContent" -->
                  <form name="LoanInfoForm" id="LoanInfoForm" method="post" action="/process/loans.jsp?action=add" onsubmit="return checkData();">
                    <table width="590" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="10"><img src="/images/lefttop_curve.gif" width="10" height="20" /></td>
                        <td width="430" bgcolor="#663300" class="headline">Danh sách đăng ký đã được chấp thuận</td>
                            ...
                            <tr>
                              <td>
                                <table width="580" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td colspan="5">
                                      <jsp:useBean id="curBooking" scope="page" class="digilib.view.BookingList" />
                                      <%
	String sCriteria = "";
	try {
	...
	curBooking.setPageSize(PageSize);
	curBooking.setPage(Page);
	curBooking.setCriteria(sCriteria);
	curBooking.open();
	int totalRecords = curBooking.getMaxRows();
...
%>
                                      ...
                                      <table width="580" border="0" cellpadding="5" cellspacing="0" bgcolor="<%= (ib % 2 == 0) ? "#ffffff" : "#ffffcc" %>" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <tr>
                                          <td width="105" style="border-right: #999999 1px solid;"><a class="picbutton" onclick="doFilter('MEMBERID=<%= curBooking.getMemberID()%>');"><%= Format.formatMemberID(curBooking.getMemberID()) %></a></td>
                                          <td width="440" style="border-right: #999999 1px solid;"><%= curBooking.getPrimaryTitle() %></td>
                                          <td width="35" align="center">
                                            <input name="accepted" type="checkbox" id="accepted" value="<%= curBooking.getTransactionNo() %>" />
                                          </td>
                                        </tr>
                                      </table>
                                      <%
