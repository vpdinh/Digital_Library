                            ...
                            <td>
                              <form name="RegistrationsInfoForm" id="RegistrationsInfoForm" method="post" action="/process/registrations.jsp">
                                <table width="580" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <jsp:useBean id="Members" scope="page" class="digilib.view.Member" />
...
%>
                                  ...
                                  <tr>
                                    <td colspan="3">
                                      <table width="580" border="0" cellpadding="0" cellspacing="5" bgcolor="<%= (i % 2 == 0) ? "#ffffff" : "#ffffcc" %>" id="divDisplay" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <tr>
                                          <td width="100" rowspan="14" align="center" valign="top"><img src="/images/member.jsp?memberid=<%= Members.getMemberID() %>" width="90" height="120" />
                                            <%= Format.formatMemberID(Members.getMemberID())%>
                                            <input name="MemberID" type="hidden" id="MemberID" value="<%= Members.getMemberID() %>" />
                                          </td>
                                        ...
                                        <tr>
                                          <td>Giới tính</td>
                                          <td><%= (Members.getGender().intValue() == 1) ? "Nam" : "Nữ" %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>Ngày sinh</td>
                                          <td><%= Format.formatShortDate(Members.getBirthday()) %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>Địa chỉ</td>
                                          <td rowspan="3" valign="top"><%= Format.formatDisplayString(Members.getAddress()) %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                        ...
                                        <tr>
                                          <td>Điện thoại</td>
                                          <td><%= Format.formatDisplayString(Members.getPhone()) %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>Fax</td>
                                          <td><%= Format.formatDisplayString(Members.getFax()) %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>Email</td>
                                        ...
                                        <tr>
                                          <td>Ngày cấp thẻ</td>
                                          <td><%= Format.formatShortDate(Members.getIssuedDate()) %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>Ngày hết hạn</td>
                                          <td><%= Format.formatShortDate(Members.getExpireDate()) %></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                          <td>Thuộc nhóm</td>
...
%>
                                              <option value="<%= GroupsInfo[j][0] %>" <%= (Members.getGroupID().equals(GroupsInfo[j][0])) ? "selected=\"selected\"" : "" %>><%= GroupsInfo[j][0] %> | <%= GroupsInfo[j][1] %></option>
...
%>
                                        ...
                                        <tr>
                                          ...
                                          <td><em><%= Format.formatTimeStamp(Members.getAudTime()) %> - (<%= Members.getAudUser() %>)</em></td>
                                          <td>&nbsp;</td>
                                        </tr>
