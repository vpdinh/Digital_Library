...
<title>D I G I L I B &gt; Thủ thư &gt; Quản lý thư viện &gt; Thu hồi tài liệu</title>
        ...
        <tr>
          <td width="300" height="50">
            <table width="300" height="50" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><!-- InstanceBeginEditable name="HeaderImage" --><img src="/images/header_returns.gif" width="300" height="50" /><!-- InstanceEndEditable --></td>
              </tr>
            </table>
          </td>
          <td width="310">
...
%>				  
  ...
  <tr>
              ...
              <tr>
                <td align="center" valign="top">
                  ...
                  <table width="150" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td>&nbsp;</td>
                      <td align="right"><a href="#">Thu hồi tài liệu</a></td>
                      <td>&nbsp;</td>
                      <td valign="bottom"><img src="/images/leftmenu_bullet.gif" width="10" height="10" /></td>
                    </tr>
                    <tr> 
            ...
            <table width="600" border="0" cellspacing="5" cellpadding="0">
              <tr>
                <td><!-- InstanceBeginEditable name="MainContent" -->
                  <form name="ReturnInfoForm" id="ReturnInfoForm" method="post" action="/process/returns.jsp?action=add" onsubmit="return checkData();">
                    <table width="590" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="10"><img src="/images/lefttop_curve.gif" width="10" height="20" /></td>
                        <td width="430" bgcolor="#663300" class="headline">Danh sách các tài liệu đang cho mượn</td>
                              ...
                              <td>
                                <table width="580" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="95" align="center" bgcolor="#083908" class="headline">Mã độc giả <a onclick="doFilter('');"><img src="/images/edit_up.gif" width="10" height="10" class="picbutton" /></a></td>
                                    <td width="440" align="center" bgcolor="#083908" class="headline">Tài liệu</td>
                                    <td width="25" align="center" bgcolor="#083908" class="headline">
                                  ...
                                  <tr>
                                    <td colspan="5">
                                      <jsp:useBean id="curLoan" scope="page" class="digilib.view.LoanList" />
                                      <jsp:useBean id="curLoanOverdue" scope="page" class="digilib.view.LoanOverdueList" />
                                      <%
	String sCriteria = "";
	try {
	...
	curLoan.setPageSize(PageSize);
	curLoan.setPage(Page);
	curLoan.setCriteria(sCriteria);
	curLoan.open();
	int totalRecords = curLoan.getMaxRows();
...
%>
                                      ...
                                      <table width="580" border="0" cellpadding="5" cellspacing="0" bgcolor="<%= (ib % 2 == 0) ? "#ffffff" : "#ffffcc" %>" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <tr>
                                          <td width="105" style="border-right: #999999 1px solid;"><a class="picbutton" onclick="doFilter('MEMBERID=<%= curLoan.getMemberID()%>');"><%= Format.formatMemberID(curLoan.getMemberID()) %></a></td>
                                          <td width="440" style="border-right: #999999 1px solid;"><%= curLoan.getPrimaryTitle() %></td>
                                          <td width="35" align="center">
                                            <input name="accepted" type="checkbox" id="accepted" value="<%= curLoan.getTransactionNo() %>" />
                                          </td>
                                        </tr>
                                      </table>
                                      <%
	...
	curLoan.close();
	curLoanOverdue.setCriteria(sCriteria);
	curLoanOverdue.open();
	while (curLoanOverdue.next()) {
%>
                                      <table width="580" border="0" cellpadding="5" cellspacing="0" bgcolor="<%= (ib % 2 == 0) ? "#ffffff" : "#ffffcc" %>" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <tr>
                                          <td width="105" style="border-right: #999999 1px solid;"><a class="picbutton" onclick="doFilter('MEMBERID=<%= curLoanOverdue.getMemberID()%>');">
                                            <%= Format.formatMemberID(curLoanOverdue.getMemberID()) %>
                                            </a></td>
                                          <td width="440" style="border-right: #999999 1px solid;">
                                            <%= curLoanOverdue.getPrimaryTitle() %>
                                          </td>
                                          <td width="35" align="center">
                                            <input name="accepted" type="checkbox" id="accepted" value="<%= curLoanOverdue.getTransactionNo() %>" />
                                          </td>
                                        </tr>
                                      </table>
<%
                                      ...
                                      <table width="580" border="0" cellpadding="0" cellspacing="5" style="border-left: #999999 1px solid; border-right: #999999 1px solid; border-bottom: #999999 1px solid;">
                                        <tr>
                                          <td align="center">
                                            ...
                                            <input name="Post" type="submit" class="button" id="Post" value="Lập phiếu" />
                                          </td>
                                        </tr>
                                      </table>
                                    </td>
