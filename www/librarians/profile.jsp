                        ...
                        <form name="ProfileForm" id="ProfileForm" method="post" action="/process/librarians.jsp?action=update" onsubmit="return checkData(0);">
                          <table width="400" border="0" cellpadding="0" cellspacing="5" class="data" id="divDisplay" style="display: inline;">
                            <tr>
                              ...
                              <td width="300"><jsp:getProperty name="curLibrarian" property="Name" />
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td width="300"><em><%= Format.formatTimeStamp(curLibrarian.getAudTime()) %> - (<%= curLibrarian.getAudUser() %>)</em></td>
                            </tr>
                            <tr align="center">
                              <td colspan="2">
                          ...
                          <table width="400" border="0" cellpadding="0" cellspacing="5" class="data" id="divEdit" style="display: none;">
                            <tr>
                              <td width="100">Họ và tên</td>
                              <td width="300">
                                <input name="Name" type="text" class="textbox" id="Name" value="<%= curLibrarian.getName() %>" maxlength="100" />
                              </td>
                            </tr>
                            <tr>
                              <td width="100">Mật khẩu</td>
                              <td width="300">
                                <input name="Password" type="password" class="textbox" id="Password" value="<%= curLibrarian.getPassword() %>" maxlength="50" />
                              </td>
                            </tr>
                            <tr>
                              <td width="100">Xác nhận mật khẩu</td>
                              <td width="300">
                                <input name="ConfirmPassword" type="password" class="textbox" id="ConfirmPassword" value="<%= curLibrarian.getPassword() %>" maxlength="50" />
                              </td>
                            </tr>
                            <tr>
                              <td width="100"><em>Cập nhật lần cuối</em></td>
                              <td width="300"><em>
                                <%= Format.formatTimeStamp(new Date()) %>
                                 - (<jsp:getProperty name="curLibrarian" property="LibrarianID" />)</em></td>
                            </tr>
                            <tr align="center">
                              <td colspan="2">
                                <input name="LibrarianID" type="hidden" id="LibrarianID" value="<%= curLibrarian.getLibrarianID() %>" />
