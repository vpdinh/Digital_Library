...
<%@ page import="digilib.view.Return" %>
			...
			case 10 : //add
				try {
					...
					for (int i = 0; i < totalRequest; i++) {
						try {
							if (ReturnDetail.add(new Long(sTransactionNo[i]), curLibrarian.getLibrarianID())) {
								processSuccessed++;
							}
						} catch (Exception e2) {}
					}
				...
				src = "/librarians/management/confirmreturns.jsp";
				break;
			case 11 : //post
				try {
					...
					for (int i = 0; i < totalRequest; i++) {
						try {
							if (Return.post(new Long(sDocumentNo[i]), curLibrarian.getLibrarianID())) {
								processSuccessed++;
							}
						} catch (Exception e2) {}
					}
				...
				src = "/librarians/management/returns.jsp";
				break;
			case 12 : //remove
				try {
					...
					for (int i = 0; i < totalRequest; i++) {
						try {
							if (ReturnDetail.remove(new Long(sDocumentNo[i]), new Long(sItemNo[i]), curLibrarian.getLibrarianID())) {
								processSuccessed++;
							}
						} catch (Exception e2) {}
					}
